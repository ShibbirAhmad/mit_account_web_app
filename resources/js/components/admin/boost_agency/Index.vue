  ...
  <div>
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          <router-link
            :to="{ name: 'boost_agency_add' }"
            class="btn btn-primary"
            ><i class="fa fa-plus"></i>Add Agency</router-link
          >
        </h1>
        <ol class="breadcrumb">
          <li>
          ...
          <div class="row ">
            <div class="col-lg-11 col-md-11">
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <table
                    class="table text-center table-centered table-striped  table-bordered table-hover"
                  >
                    <thead>
                      <tr>
                        <th>#</th>
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <select
                required
                class="form-control"
                v-model="payment_paid_form.paid_by"
              >
