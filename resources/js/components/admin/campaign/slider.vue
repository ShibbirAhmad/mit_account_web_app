            ...
            <div class="col-lg-10 col-lg-offset-1">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <div class="row">
                    <div class="col-lg-6">
                      <h3 class="box-title">Campaign Slider</h3>
                    </div>
                  </div>
                </div>
                <div class="box-body">
                  <div v-for="image in images" :key="image.id">
                    <img
                      style="
                        ...
                        border-radius: 10px;
                      "
                      :src="basePath + image.image"
                      alt=""
                    />
                    <a
                      @click.prevent="remove(image.id)"
                      href="#"
              ...
              <div class="form-group">
                <label
                  ...
                  <small style="font-size: 10px"
                    >Image Size Must Be 1100*300px</small
                  >
                </label>
                <input
                  type="file"
  ...
  methods: {
    ...
    remove(id) {
      if (confirm("are  you sure? rou want to remove this")) {
        axios.get("/api/campagin/image/remove/" + id).then((resp) => {
          if (resp.data.success) {
            this.getCampaignSlider();
          }
        });
