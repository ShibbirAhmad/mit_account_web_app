          ...
          <div class="row justify-content-center">
            ...
            <div class="col-lg-8">
              <div class="box box-success">
                ...
                <div class="box-body">
                  <div class="form-group">
                    <label>Scan Barcode || Product code</label>
                    <input
                      type="text"
                      name="name"
                      class="form-control"
...
export default {
  ...
  methods: {
    ...
    add() {
      ...
      //start progress bar when submit from
      this.$Progress.start();
      this.form
        .post("/create/order")
        .then((resp) => {
          ...
          .then((resp) => {
            if (resp.data.status == "SUCCESS") {
              ...
              for (let i = 0; i < resp.data.product.length; i++) {
                //check the product stock availity
    ...
    totalCalculation() {
      ...
      if (
        ...
        Swal.fire({
          type: "warning",
          text: `Discount amount ${this.form.discount} bigger than total amount ${total} ?`,
        });
    ...
    cityWiseSubCity(city_id) {
      ...
      axios
        .get("/city/wise/sub/city/" + city_id)
        .then((resp) => {
          if (resp.data.length) {
