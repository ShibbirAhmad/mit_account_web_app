<template>
  <div>
                  ...
                  <div class="row" style="margin-bottom: 3px">
                    <div class="col-lg-3">
                      ...
                      >
                        ...
                        <option value="CANCEL ALL">Cancel ALl</option>
                        <option value="EXPORT FOR PAPER-FLY">
                          EXPORT FOR PAPER-FLY
                        </option>
                        <option value="EXPORT FOR REDX">EXPORT FOR REDX</option>
                      </select>
                    </div>
                      ...
                      >
                        ...
                        <td>
                          <div v-if="order.order_item.length > 0">
                            <img
                              v-if="order.order_item[0].product"
                              style="width: 65px"
                              height="65px"
                              :src="
                                base_url +
                              ...
                              "
                            />
                            <p v-if="order.order_item[0].product">
                              {{
                        ...
                        <td>
                          ...
                          >
                            ...
                            <button
                              class="btn btn-sm btn-success action-btn"
                              v-if="
                                order.status == 4 && $can('Delivered Order')
                              "
    ...
    <modal name="multi_order_shipment" :width="300" :height="200">
      <div style="padding: 10px" class="card">
        <div class="card-body">
          <form @submit.prevent="shipmentAll">
            <div class="form-group">
              <label>Courier</label>
              <select
                required
...
export default {
  ...
  methods: {
    ...
    //get order list
    ordersList(page = 1) {
      if (this.pre_route == "viewOrder") {
        this.pre_route = "";
        page = window.document.order_page_number;
      }
    ...
    selectBulkAction() {
      ...
      if (action_type == "EXPORT FOR PAPER-FLY") {
        window.open(
          "/export/orders/for/paper-fly/" + this.select_order_id,
          "_blank"
        );
      }

      if (action_type == "EXPORT FOR REDX") {
        window.open(
    ...
    shipmentAll() {
      axios
        .post("/api/shipment/all/order", {
          courier_id: this.courier.courier_id,
          memo_no: this.courier.memo_no,
          orders_id: this.select_order_id,
        })
        .then((resp) => {
          console.log(resp);
