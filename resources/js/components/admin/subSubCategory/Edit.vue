                            ...
                            <div class="box-body">
                                ...
                                <form @submit.prevent="update" v-else @keydown="form.onKeydown($event)"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="show_homepage" v-model="form.show_homepage"  :class="{ 'is-invalid': form.errors.has('show_homepage') }">
                                            <option value="Select condition"  disabled>Select condition</option>
                                            <option value="1">Yes</option>
                                            <option value="0">No</option>
                                        </select>
                                        <has-error :form="form" field="show_homepage"></has-error>
                                    </div>
                                    <div class="form-group">
                ...
                axios.get('/edit/subSubCategory/' + this.$route.params.id)
                    .then((resp) => {
                        ...
                        if (resp.data.status == 'SUCCESS') {
                            ...
                            this.form.show_homepage=resp.data.subSubCategory.show_homepage?resp.data.subSubCategory.show_homepage:0;
