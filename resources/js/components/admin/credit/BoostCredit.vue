  ...
  <div>
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          <router-link :to="{ name: 'boost_credit_add' }" class="btn btn-primary"
            ><i class="fa fa-plus"></i
          ></router-link>

          <router-link :to="{ name: 'boost_debit' }" class="btn btn-info">Debit</router-link>
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Boost Credit</li>
        </ol>
      </section>
