  ...
  <div>
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          <router-link :to="{ name: 'properties_credit_add' }" class="btn btn-primary"
            ><i class="fa fa-plus"></i
          ></router-link>

          <router-link :to="{ name: 'properties_debit' }" class="btn btn-info">Debit</router-link>
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Properties Credit</li>
        </ol>
      </section>
                  ...
                  <table class="table table-bordered table-striped table-hover ">
                    ...
                    <tbody>
                      ...
                      <tr v-for="(credit, index) in credits.data" :key="index">
                       ...
                       <td style="width:90px;">{{ credit.created_at }}</td>
...
export default {
  ...
  methods: {
   ...
   balanceList() {
      axios
        .get("/api/balance/list/properties")
        .then((resp) => {
