              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <div class="row print_info_container">
                    ...
                    <div class="col-md-3 col-sm-5 description">
                      <div v-if="sale.sale_type == 1">
                        <!-- <p >Sale Type: Office Sale </p> -->
                        <p>
                          Name: <strong>{{ sale.name }}</strong>
                        </p>
                        <p>
                        ...
                        <p>
                          Invoice No:
                          <strong v-if="sale.invoice_no">{{
                            sale.invoice_no
                          }}</strong>
                          <strong v-else> {{ "S-" + sale.id }}</strong>
                        </p>
                      </div>
                      <div v-if="sale.sale_type == 3">
                        <!-- <p >Sale Type: Office Sale </p> -->
                        <p>
                         Supplier Name: <strong>{{ sale.name }}</strong>
                        </p>
                        <p>
                         Supplier Mobile: <strong>{{ sale.mobile_no }}</strong>
                        </p>
                        <p class="address_line">
                         Supplier Address: <strong>{{ sale.address }}</strong>
                        </p>
                      ...
                      <div  v-if="sale.sale_type == 2">
                        ...
                        <p>
                          Mobile No:
                          <strong>{{
                            sale.company ? sale.company.phone : ""
                          }}</strong>
                        </p>
                        <p class="address_line">
                          Address:
                          <strong>{{
                            sale.company ? sale.company.address : ""
                          }}</strong>
                        </p>
                    ...
                    >
                      <img
                        ...
                        alt="logo"
                      />
                      <p class="address_line" style="margin-top: -10px">
                        Office: House:02, Lane:11,Block:A, Banaroshi Polli,
                        section-10, Mirpur,Dhaka.
                      </p>
                      <p>Email: support@mohasagor.com</p>
                      <p>
                        Hot Line: <strong> 09636 203040/01633-666 222</strong>
                      </p>
                      <p>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr v-for="(item, index) in details" :key="index">
                            ...
                            <td>
                              <span
                                :class="{ 'text-danger': item.status == 2 }"
                                >{{ item.total }}</span
                              >
                            </td>
                          </tr>
                  ...
                  <div class="row exchange-memo" v-show="sale.status == 2">
                    <img
                      :src="base_url + 'images/static/exchange.png'"
                      alt=""
                    />
                  </div>
                  ...
                  <div class="row">
                    <div
                      class="col-lg-2"
                      style="margin-left: 27px; text-align: center;margin-top:30px;"
                    >
                      <h4> {{ sale.create ? sale.create.name : '' }} </h4>
                      <h5 style="border-top: 2px dotted #000;">
