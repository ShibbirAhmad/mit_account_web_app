  ...
  <div>
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          <router-link :to="{ name: 'properties_debit_add' }" class="btn btn-primary"
            ><i class="fa fa-plus"></i
          ></router-link>
            <router-link :to="{ name: 'properties_credit' }" class="btn btn-info"
            >Credit</router-link>
...
export default {
  ...
  methods: {
    ...
    balanceList() {
      axios.get("/api/balance/list/properties")
        .then((resp) => {
