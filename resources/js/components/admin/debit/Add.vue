              ...
              <div class="box-body">
                ...
                >
                  ...
                  <!-- <div class="form-group" id="signatur-pad">
                    <div v-if="old_signature">
                      <img
                        v-if="form.old_signature.length > 0"
                        :src="base_link + form.old_signature"
                        style="min-height: 250px; max-width: 800px"
                      />
                      <br />

                      <button class="btn" @click="old_signature = false">
                        Change
                      </button>
                    </div>
