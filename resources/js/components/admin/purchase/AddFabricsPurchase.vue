                ...
                <div class="row">
                 ...
                 <div class="col-lg-3">
                   <div class="form-group">
                      <label for="">Paid By</label>
                        <select name="paid_by" required class="form-control" v-model="paid_by">
                 ...
                 <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <input type="text" name="comment" placeholder="write comment" v-model="comment" class="form-control">
                    </div>
                  </div>
               </div>
