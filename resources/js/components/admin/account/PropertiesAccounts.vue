<template>
  <div>
        ...
        <div class="custom-box">
          <div class="custom-box-body">
            <h4
              ...
              @click="displayTodayPropertiesCreditAccountDetails(balance)"
              :key="c_index"
            >
              In {{ balance.name }} :
              <strong>{{ parseInt(todayPropertiesCreditBalance(balance)) }}</strong>
            </h4>
            <h4>
              In Total : <strong>{{ todayProperteisTotalCredit() }} </strong>
            </h4>
          </div>
      ...
      <div class="col-lg-4">
        <div class="custom-box">
          <div class="custom-box-body">
            <h4
              v-for="(balance, c_index) in balance"
              @click="displayTodayPropertiesDebitAccountDetails(balance)"
              title="click to see details"
              :key="c_index"
            >
              In {{ balance.name }} :
              <strong>{{ parseInt(todayPropertiesDebitBalance(balance)) }}</strong>
            </h4>

            <h4>
              In Total : <strong>{{ todayPropertiesTotalDebit() }} </strong>
            </h4>
          </div>
      ...
      <div class="col-lg-4">
        <div class="custom-box">
          <div class="custom-box-body">
            <h4
              v-for="(balance, c_index) in balance"
              @click="displayPropertiesAccountDetails(balance)"
              title="click to see details"
              :key="c_index"
            >
              In {{ balance.name }} :
              <strong>{{ parseInt(debitPropertiesCreditSubstraction(balance)) }}</strong>
            </h4>
            <h4>
              In Total <strong> {{ totalPropertiesBalance() }} </strong>
            </h4>
          </div>
    ...
    <modal name="account_today_properties_debit_details_modal" :width="800" :height="400">
    ...
    <!-- start today credit payment store modal  -->
    <modal name="account_today_properties_credit_details_modal" :width="800" :height="400">
      <div class="card" style="padding: 20px">
        <div class="card-header text-center">
          <h4 class="heading">{{ account_name }}</h4>
        </div>
    ...
    <modal name="account_properties_details_modal" :width="800" :height="400">
      <div class="card" style="padding: 20px">
        <div class="card-header text-center">
          <h4 class="heading">{{ account_name }}</h4>
        </div>
...
export default {
  ...
  methods: {
    ...
    displayTodayPropertiesDebitAccountDetails(balance) {
      ...
      this.$modal.show("account_today_properties_debit_details_modal");
    },

    displayTodayPropertiesCreditAccountDetails(balance) {
      this.account_name = balance.name;
      let credit_history = [];
      ...
      this.$modal.show("account_today_properties_credit_details_modal");
    },

    displayPropertiesAccountDetails(balance) {
      this.account_name = balance.name;
      let credit_history = [];
      let debit_history = [];
      ...
      this.$modal.show("account_properties_details_modal");
    },

    //today credit balance counter
    todayPropertiesCreditBalance(balance) {
      let amount = 0;
    ...
    todayPropertiesDebitBalance(balance) {
      let amount = 0;
    ...
    debitPropertiesCreditSubstraction(balance) {
      if (this.balance.length > 0) {
        let debit_amount = 0;
        let credit_amount = 0;
