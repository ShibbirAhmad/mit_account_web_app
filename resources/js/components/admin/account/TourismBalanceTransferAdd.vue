    ...
    <div class="content-wrapper">
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Tourism Fund Transfer</li>
        </ol>
      </section>
          ...
          <div class="col-lg-6 col-lg-offset-2">
            <div class="box box-primary">
              <div class="box-header with-border text-center">
                <h3 class="box-title">Tourism Fund Transfer</h3>
              </div>
              <div class="box-body">
...
export default {
  ...
  methods: {
    balanceList() {
      axios.get("/api/balance/list/tourism").then((resp) => {
      ...
      this.form
        ...
        .then((resp) => {
          ...
          if (resp.data.status == "OK") {
            this.$router.push({ name: "tourism_fund_transfer" });
