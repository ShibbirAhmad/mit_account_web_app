<template>
  <div>
        ...
        <div class="custom-box">
          <div class="custom-box-body">
            <h4
              ...
              @click="displayTodayBoostCreditAccountDetails(balance)"
              :key="c_index"
            >
              In {{ balance.name }} :
              <strong>{{ parseInt(todayBoostCreditBalance(balance)) }}</strong>
            </h4>
            <h4>
              In Total : <strong>{{ todayBoostTotalCredit() }} </strong>
            </h4>
          </div>
      ...
      <div class="col-lg-4">
        <div class="custom-box">
          <div class="custom-box-body">
            <h4
              v-for="(balance, c_index) in balance"
              @click="displayTodayBoostDebitAccountDetails(balance)"
              title="click to see details"
              :key="c_index"
            >
              In {{ balance.name }} :
              <strong>{{ parseInt(todayBoostDebitBalance(balance)) }}</strong>
            </h4>

            <h4>
              In Total : <strong>{{ todayBoostTotalDebit() }} </strong>
            </h4>
          </div>
      ...
      <div class="col-lg-4">
        <div class="custom-box">
          <div class="custom-box-body">
            <h4
              v-for="(balance, c_index) in balance"
              @click="displayBoostAccountDetails(balance)"
              title="click to see details"
              :key="c_index"
            >
              In {{ balance.name }} :
              <strong>{{ parseInt(debitCreditSubstractionBoost(balance)) }}</strong>
            </h4>
            <h4>
              In Total <strong> {{ totalBoostBalance() }} </strong>
            </h4>
          </div>
    ...
    <modal name="account_today_boost_debit_details_modal" :width="800" :height="400">
    ...
    <!-- start today credit payment store modal  -->
    <modal name="account_today_boost_credit_details_modal" :width="800" :height="400">
      <div class="card" style="padding: 20px">
        <div class="card-header text-center">
          <h4 class="heading">{{ account_name }}</h4>
        </div>
    ...
    <modal name="accountz_boost_details_modal" :width="800" :height="400">
      <div class="card" style="padding: 20px">
        <div class="card-header text-center">
          <h4 class="heading">{{ account_name }}</h4>
        </div>
...
export default {
  ...
  methods: {
    ...
    displayTodayBoostDebitAccountDetails(balance) {
      ...
      this.$modal.show("account_today_boost_debit_details_modal");
    },

    displayTodayBoostCreditAccountDetails(balance) {
      this.account_name = balance.name;
      let credit_history = [];
      ...
      this.$modal.show("account_today_boost_credit_details_modal");
    },

    displayBoostAccountDetails(balance) {
      this.account_name = balance.name;
      let credit_history = [];
      let debit_history = [];
      ...
      this.$modal.show("accountz_boost_details_modal");
    },

    //today credit balance counter
    todayBoostCreditBalance(balance) {
      let amount = 0;
    ...
    todayBoostDebitBalance(balance) {
      let amount = 0;
    ...
    debitCreditSubstractionBoost(balance) {
      if (this.balance.length > 0) {
        let debit_amount = 0;
        let credit_amount = 0;
