<template>
  <div>
        ...
        <div class="custom-box">
          <div class="custom-box-body">
            <h4
              ...
              @click="displayTodayCreditAccountDetails(balance)"
              :key="c_index"
            >
              In {{ balance.name }} :
              <strong>{{ parseInt(todayCreditBalance(balance)) }}</strong>
            </h4>
            <h4>
              In Total : <strong>{{ todayTotalCredit() }} </strong>
            </h4>
          </div>
      ...
      <div class="col-lg-4">
        <div class="custom-box">
          <div class="custom-box-body">
            <h4
              v-for="(balance, c_index) in balance"
              @click="displayTodayDebitAccountDetails(balance)"
              title="click to see details"
              :key="c_index"
            >
              In {{ balance.name }} :
              <strong>{{ parseInt(todayDebitBalance(balance)) }}</strong>
            </h4>

            <h4>
              In Total : <strong>{{ todayTotalDebit() }} </strong>
            </h4>
          </div>
      ...
      <div class="col-lg-4">
        <div class="custom-box">
          <div class="custom-box-body">
            <h4
              v-for="(balance, c_index) in balance"
              @click="displayAccountDetails(balance)"
              title="click to see details"
              :key="c_index"
            >
              In {{ balance.name }} :
              <strong>{{ parseInt(debitCreditSubstraction(balance)) }}</strong>
            </h4>
            <h4>
              In Total <strong> {{ totalBalance() }} </strong>
            </h4>
          </div>
    ...
    <modal name="account_today_debit_details_modal" :width="800" :height="400">
    ...
    <!-- start today credit payment store modal  -->
    <modal name="account_today_credit_details_modal" :width="800" :height="400">
      <div class="card" style="padding: 20px">
        <div class="card-header text-center">
          <h4 class="heading">{{ account_name }}</h4>
        </div>
    ...
    <modal name="account_details_modal" :width="800" :height="400">
      <div class="card" style="padding: 20px">
        <div class="card-header text-center">
          <h4 class="heading">{{ account_name }}</h4>
        </div>
...
export default {
  ...
  methods: {
    ...
    displayTodayDebitAccountDetails(balance) {
    ...
    displayTodayCreditAccountDetails(balance) {
      this.account_name = balance.name;
      let credit_history = [];
