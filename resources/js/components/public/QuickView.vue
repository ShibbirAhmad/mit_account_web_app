                        ...
                        <li>
                          ...
                          <h3>
                            ...
                            <span class="price-new">&#2547 {{quick_view_product.price}}</span>
                               <span
                          v-if="quick_view_product.discount_type == 'flat' && quick_view_product.discount > 0"
                          class="discount"
                        >
                         <i class="fa fa-star discount_star1"> </i>
                           <i class="fa fa-star discount_star2"> </i>
                          {{ quick_view_product.discount }}&#2547; <span class="d_off">off</span> </span
                        >
                        <span
                          v-if="quick_view_product.discount_type == 'percentage' && quick_view_product.discount > 0"
                          class="discount"
                        >
                          <i class="fa fa-star discount_star1"> </i>
                          <i class="fa fa-star discount_star2"> </i>
                          {{
                            (
                              (quick_view_product.discount / quick_view_product.sale_price) *
                              100
                            ).toFixed(0)
