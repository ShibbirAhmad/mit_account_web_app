        ...
        <div class="row justify-content-center break">
            <div class="col-lg-4  ml-5">
                <div class="header-left ml-4 text-left">
                    <img class="inv_logo" src="{{ asset('frontend/image/logo.png') }}" alt="logo" height="90px" width="300px">
                     <p class="moha_title_inv" >Trusted Online Shopping In Bangladesh</p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="pull-right moha_add_inv" >
                    <p style="text-align:left" class="invoice_address" >
                      <address style="line-height:10px">Office: House: 02, Lane: 11, Block: A</address>
                       <address style="line-height:10px">Benarashi Polly, Section-10, Mirpur, Dhaka.</address>
                         E-mail: support@mohasagor.com <br/>
                         Hot Line: 09636-203040/01635212121
                    </p>
