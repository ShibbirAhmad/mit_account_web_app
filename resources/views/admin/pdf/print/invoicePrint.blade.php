        ...
        <div class="row justify-content-center break">
            <div class="invoice_header_left_section">
                    <ul class="customer_info_list">
                        <li> <strong> Name:  {{ $order->customer->name  }} </strong>  </li>
                        <li> <strong> Mobile: {{ $order->cutomer_phone }} </strong>  </li>
                        <li> <strong> Address:        @if(!empty($order->customer->address))
            ...
            <div class="invoice_header_right_section">
              <img class="company_logo" src="{{ asset('frontend/image/logo.png') }}" alt="logo">
                <div class="pull-right moha_add_inv" >
                    ...
                    <p>Hot Line: 09636-203040/01630-990000</p>
                ...
                <table class="table table-bordered moha_tbl_inv" style="margin-top: 5px;">
                   ...
                   @endif
                    ...
                    <tr>
                        ...
                        <td colspan="2"> <strong> = {{ countOrderTotayQty($order->orderItem) }} </strong> </td>
                    </tr>
                    <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" > {{ intval($order->shipping_cost) }} Tk</td>
                        </tr>

                         <tr>
                            <td colspan="5" class="text-right">Payable amount with shipping charge :</td>
                            <td colspan="2" > {{ (intval($order->shipping_cost) + intval($order->total)) - intval($order->discount) }} Tk</td>
                        </tr>
                         <tr>
                         ...
                         <tr>
                            ...
                            <td colspan="2" style="font-weight:bold;color:#000;background-color: #04AA6D !important" >{{ ($order->total + $order->shipping_cost)- ($order->paid + $order->discount) }} Tk</td>
                        </tr>
