    ...
    <div class="container">
        <div class="row">
             <div class="address">
                ...
                <br/>
                <div class="supplier_money" style="display: inline-block; margin-left:300px;margin-top:-22px;">
                    Total Purchase: <strong> {{ $supplier_amount['total_purchase_amount'] }} </strong>  BDT
                    <br/>
                    Total Paid : <strong> {{ $supplier_amount['total_paid_amount'] }}   </strong> BDT
                    <br/>
                    Due Amount: <strong>  {{  $supplier_amount['total_due_amount'] }}   </strong>  BDT
                 </div>
              </div>
